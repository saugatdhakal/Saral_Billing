...
@section('content')
<center class="m-2"><h1>USER LIST</h1></center>
@if (count($errors)>0)
    ...
    <div class="col-md-12">
        <div class="card card-body shadow mt-4">
            ...
            <div class="row m-2">
                ...
                <div class="col-md-2">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#addUser"  class="btn btn-outline-primary">ADD USER</button>
                </div>
            </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-md-6">
                                            <button style="width: 100%" type="button"
                                                class="btn btn-primary changePassword"  data-bs-toggle="modal" data-id="{{$row->id}}" data-bs-target="#change_password">Change Password</button>
                                        </div>
                                        <div class="col-md-4">
                                            <button style="width: 100%" type="button" 
                                                class="btn btn-success edit" data-bs-toggle="modal" data-id="{{$row->id}}" data-bs-target="#change_details">Edit
                                            </button>
                                        </div>
                                    </div>
                                    </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <input value="submit" type="submit" class="m-2 bg-primary btn text-white fw-bold">
                            </div>
                            <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <input type="text" name="first_password" id="firstPassword" placeholder="New Password" class="form-control m-2 ">
                        <input type="text" name="second_password" id="secondPassword" placeholder="Reapet New Password" class="form-control m-2">
...
<div class="modal fade" id="change_details" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <input type="text" name="name" placeholder="Name" id="names" class="form-control m-2 ">
                        <input type="text" name="email" placeholder="Email" id="email" class="form-control m-2">
                        <select name="is_admin" class="form-select m-2">
