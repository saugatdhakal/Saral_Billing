            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{route('purchase.invoice1',['id'=>$purchase->id])}}">Layout
                                1</a></li>
                        <li><a class="dropdown-item" href="{{route('purchase.invoice2',['id'=>$purchase->id])}}">Layout
                                2</a></li>
