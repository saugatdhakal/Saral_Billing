...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">PUJA FANCY STORE</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i id="userIcon"class="fas fa-users fa-lg"></i><!-- <i class="fas fa-columns"></i> Font Awesome fontawesome.com --></div>
                               Account 
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('Account.index')}}"><i class="far fa-file-alt"></i> &#160 Account Dashboard</a>
                                    <a class="nav-link" href="{{route('account.create')}}"><i class="fas fa-user-plus"></i> &#160 Create Account </a>
