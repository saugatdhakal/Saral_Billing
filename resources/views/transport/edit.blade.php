...
<h2 class="m-2">Edit Transport Details</h2>
@if ($errors->any())
...
<div class="card flex-center m-2">
    <form class="row g-3 mt-2 needs-validation" action="/transport/{{$transport->id}}" method="POST" novalidate>
        @csrf
        @method('PUT')
        <div class="row m-2">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="name" value="{{$transport->name}}"
                    placeholder="Transport Name" autoFocus="true" required>
        ...
        <div class="row m-2">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="address" value="{{$transport->address}}"
                    placeholder="Transport Address" required>
                <div class="invalid-feedback">
                    Addess is Empty!!
                </div>
            </div>
        ...
        <div class="row m-2">
            ...
            <div class="col-md-4">
                <input type="number" class="form-control" name="number" value="{{$transport->contact_number}}"
        ...
        <div class="row m-2">
            ...
            <div class="col-md-4">
                ...
                <textarea class="form-control" name="remark" placeholder="Remark"
                    rows="3">{{$transport->remark}}</textarea>
            </div>
        </div>
