            ...
            <div class="card-body">
                ...
                <center>
                    <p class="card-text" style="color:rgb(108, 108, 108);font-size:20px;font-weight:bold;">TOTAL DUE
                        AMOUNT</p>
                    <p class="card-text" style="color:rgb(108, 108, 108);font-size:25px;font-weight:bold;"> Rs. 1,43,00
                    </p>

                </center>
                <hr>
                <p class="card-text" style="color:rgb(108, 108, 108)">Thank you for choosing puja fancy store for
                    shopping. Please find the attached Sale Invoice.</p>

                <p style="margin-top:1cm;margin-buttom:0;color:rgb(108, 108, 108)"> This is auto-generated email. Please
