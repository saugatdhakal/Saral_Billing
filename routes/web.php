...
//* Sale
Route::get('sales/email/{id}',[SaleController::class,'email'])->name('sales.email');
Route::get('/sale/salesChart',[SaleController::class,'salesChart'])->name('sales.salesChart');
...
Route::get('/salesReturn/returnItem/{id}',[SalesReturnController::class,'returnItem'])->name('salesReturn.returnItem');
Route::get('/salesReturn/trashIndex',[SalesReturnController::class,'trashIndex'])->name('salesReturn.trashIndex');
Route::get('/salesReturn/trashAjaxIndex',[SalesReturnController::class,'trashAjaxIndex'])->name('salesReturn.trashAjaxIndex');
